...
GLOG_logtostderr=1 $CAFFE_TOOLS/convert_image_slice_set.bin \
    $DATA_DIR/train_slice_ish_E11.5_multi_class.txt \
    $MDB_DIR/train_slice_lvdb_ish_E11.5_multi_class 1 \
	"leveldb" \
    $RESIZE_HEIGHT $RESIZE_WIDTH
...
GLOG_logtostderr=1 $CAFFE_TOOLS/convert_image_slice_set.bin \
    $DATA_DIR/all_test_slice_ish_E11.5_multi_class.txt \
    $MDB_DIR/all_test_slice_lvdb_ish_E11.5.5_multi_class 1 \
	"leveldb" \
    $RESIZE_HEIGHT $RESIZE_WIDTH
