...
CAFFE_TOOLS=$HOME_ROOT/$PROJ_ROOT/code/caffe/bin
...
GLOG_logtostderr=1 $CAFFE_TOOLS/convert_image_slice_set.bin \
    $DATA_DIR/train_slice_ish_E18.5.txt \
    $MDB_DIR/train_slice_lvdb_ish_E18.5 1 \
	"leveldb" \
    $RESIZE_HEIGHT $RESIZE_WIDTH
...
GLOG_logtostderr=1 $CAFFE_TOOLS/convert_image_slice_set.bin \
    $DATA_DIR/all_test_slice_ish_E18.5.txt \
    $MDB_DIR/all_test_slice_lvdb_ish_E18.5 1 \
	"leveldb" \
    $RESIZE_HEIGHT $RESIZE_WIDTH
