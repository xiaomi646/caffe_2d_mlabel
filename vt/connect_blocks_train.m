...
for index = startR : lastR
    ...
    for j = 1 : num_blocks
        ...
        filename2 = strcat('/home/wzhang/caffe_2d_mlabel/vt/dmatrix/Train_block_feature_matrix_row',num2str(j-1),'_column_',num2str(index-1),'.mat');
        load(filename2);
        feature_matrix_small = [feature_matrix_small; data_block];
        
    end

    filename = strcat('/home/wzhang/caffe_2d_mlabel/vt/dmatrix/Train_feature_matrix_small_column_', num2str(index-1),'.mat');
