...
filename = strcat(root_dir, '/Caffe_Matrix_Train_conv5_3_vt_models_iter_15000_',num2str(index-1),'.mat') 
...
for j = 1 : num_blocks
    ...
    filename2 = strcat('/home/wzhang/caffe_2d_mlabel/vt/dmatrix/Train_block_feature_matrix_row',num2str(index-1),'_column_',num2str(j-1),'.mat');
